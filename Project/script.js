var initialAmt = actualamt = 2000.00;
...
if(accType = 1){
		...
		var result = parseFloat(amtval) + parseFloat(SavAmt);
		...
		var result = parseFloat(amtval) + parseFloat(CheckAmt);
...
if(accType = 1){
	var htmlVal = "Name: "+username+" <br> Account: "+accountTypes[accType]+" <br> Initial Balance: $"+SavAmt+" <br>";
}

else{
	var htmlVal = "Name: "+username+" <br> Account: "+accountTypes[accType]+" <br> Initial Balance: $"+CheckAmt+" <br>";
}
